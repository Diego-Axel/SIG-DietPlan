...
void menu_dev(void) {
  ...
  printf("\t///      Luís Henrique                                      Diêgo Axel     ///\n");
  printf("\t///------------------------------------------------------------------------///\n");
  printf("\t///                                                                        ///\n");
  printf("\t///                                 GitHub:                                ///\n");
  printf("\t///         Luis27h                                         Diego-Axel     ///\n");
  printf("\t///------------------------------------------------------------------------///\n");
  printf("\t///                                                                        ///\n");
  printf("\t///                            Entre Em Contato:                           ///\n");
  printf("\t///  luis27marciano @gmail.com                    diegoaxelbsr@gmail.com   ///\n");
  printf("\t///       (84) 99627-4880                             (84) 99977-4459      ///\n");
  printf("\t///                                                                        ///\n");
  printf("\t//////////////////////////////////////////////////////////////////////////////\n");
  printf("\n"); 
  printf("\tTecle <ENTER> para retornar...");
